...
!Calcular shape derivatives, y area de elementos
...
!Calcular integral de terminos de estabilizacion
...
!Interpolacion de gas en equilibrio
...
!Calcular fuerzas en cada uno de los sets
...
!Calcular cantidad de letras del nombre de archivo
...
!Calcular nodos vecinos y ensamblar laplaciano
...
!Multiple forma de entrada de datos
